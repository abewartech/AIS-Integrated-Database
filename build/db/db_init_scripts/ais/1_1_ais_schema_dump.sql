...
-- Name: ais_traj_2020; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: daily_pos_cagg; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: data_sources_cagg; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: mid_to_country; Type: TABLE; Schema: ais; Owner: rory
--
...
-- Name: vessel_details_cagg; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: ship_details_agg; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: martin_query; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: martin_query_sizes; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: martin_query_sizes_class_flag_100nm; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: nav_status; Type: TABLE; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_30min_cagg; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_30min_dist_cagg; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_source_counter; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: storm_trajectory; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: traj_testing; Type: MATERIALIZED VIEW; Schema: ais; Owner: rory
--
...
-- Name: vessel_trajectory; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: vessel_trajectory_2021_06_28; Type: VIEW; Schema: ais; Owner: rory
--
...
-- Name: ais_traj_2020_st_makeline_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_event_time_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_mmsi_event_time_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: pos_reports_position_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: ship_details_agg_mmsi_ix; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Dependencies: 6499
-- Name: INDEX ship_details_agg_mmsi_ix; Type: COMMENT; Schema: ais; Owner: rory
--
...
-- Name: vessel_traj_4h_gaps_2020_mmsi_date_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: vessel_traj_4h_gaps_2020_traj_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: voy_reports_event_time_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: voy_reports_mmsi_event_time_idx; Type: INDEX; Schema: ais; Owner: rory
--
...
-- Name: pos_reports ts_cagg_invalidation_trigger; Type: TRIGGER; Schema: ais; Owner: rory
--
...
-- Name: voy_reports ts_cagg_invalidation_trigger; Type: TRIGGER; Schema: ais; Owner: rory
--
...
-- Name: pos_reports ts_insert_blocker; Type: TRIGGER; Schema: ais; Owner: rory
--
...
-- Name: voy_reports ts_insert_blocker; Type: TRIGGER; Schema: ais; Owner: rory
--
...
-- Dependencies: 14
-- Name: SCHEMA ais; Type: ACL; Schema: -; Owner: rory
--
