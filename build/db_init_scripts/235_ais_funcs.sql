-- -- PROCEDURE: ais.build_trajectories(integer, jsonb)

-- -- DROP PROCEDURE IF EXISTS ais.build_trajectories(integer, jsonb);

-- CREATE OR REPLACE PROCEDURE ais.build_trajectories(
-- 	job_id integer,
-- 	config jsonb)
-- LANGUAGE 'plpgsql'
-- AS $BODY$
...
-- CREATE OR REPLACE FUNCTION ais.ais_aggregation_1km_full(
-- 	begin_time timestamp without time zone,
-- 	end_time timestamp without time zone)
--     RETURNS TABLE(gid double precision, event_date date, type_and_cargo character varying, cardinal_seg numeric, sog_bin numeric, track_count bigint, avg_time_delta double precision, cum_time_in_grid double precision) 
--     LANGUAGE 'sql'
--     COST 100
...
-- CREATE OR REPLACE PROCEDURE ais.create_yesterday_density(
-- 	job_id integer,
-- 	config jsonb)
-- LANGUAGE 'plpgsql'
-- AS $BODY$
...
-- -- DO TSDB user defined functions here...